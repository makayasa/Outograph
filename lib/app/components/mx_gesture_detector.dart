...
typedef MxGestureDetectorCallback = void Function(Matrix4 matrix, Matrix4 translationDeltaMatrix, Matrix4 scaleDeltaMatrix, Matrix4 rotationDeltaMatrix);

/// [MxGestureDetector] detects translation, scale and rotation gestures
...
/// parameters.
///
class MxGestureDetector extends StatefulWidget {
  /// [Matrix4] change notification callback
  ///
  final MxGestureDetectorCallback onMatrixUpdate;
  ...
  final Matrix4? mMatrix;
  final Matrix4? tMatrix;
  final Matrix4? sMatrix;
  final Matrix4? rMatrix;
  final bool undoz;
  final HitTestBehavior? behavior;
  final Function()? onTap;

  const MxGestureDetector(
      {Key? key,
  ...
  @override
  _MxGestureDetectorState createState() => _MxGestureDetectorState();
...
class _MxGestureDetectorState extends State<MxGestureDetector> {
  ...
  void onScaleUpdate(ScaleUpdateDetails details) {
    if (tempMatrix != null && tempTrans != null && tempScale != null && tempRot != null) {
      tempMatrix = null;
      tempTrans = null;
      tempScale = null;
      tempRot = null;
